...
export default function Onboarding({
  ...
  const [recipient, setRecipient] = useState("0xB2673DEa091820C1678dcF7052d836D0a816f991");
  ...
  const performClaim = async () => {
    try {
      ...
      // toast is already handled in handleFaucetRequest
    }
  };
        ...
        {step === 1 && (
          <div className="space-y-4 animate-in fade-in zoom-in duration-300">
            ...
            <p className="text-gray-600">
              To get started, you need some testnet tokens (USDT0) to pay for transactions and initial deposits.
            </p>
            <div className="pt-4">
              <button
              ...
              >
                {faucetLoading ? "Requesting..." : "Claim 0.25 USDT0"}
              </button>
            </div>
