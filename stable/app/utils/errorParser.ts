...
export function parseError(error: AppError): string {
  ...
  if (msg.includes("insufficient funds") || msg.includes("exceeds balance")) {
    return "You don't have enough funds to cover the gas fee for this transaction.";
  }
  ...
  // Network
  if (msg.includes("Network Error") || msg.includes("connection refusing") || msg.includes("Failed to fetch")) {
